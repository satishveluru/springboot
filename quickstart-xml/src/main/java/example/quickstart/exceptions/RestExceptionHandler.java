...
import example.quickstart.error.ApiError;

@Order(Ordered.HIGHEST_PRECEDENCE)
@ControllerAdvice
public class RestExceptionHandler extends ResponseEntityExceptionHandler {

    Logger Logger = LoggerFactory.getLogger("example.quickstart.exceptions.RestExceptionHandler");
     ...
     * @return the ApiError object
     */
    protected ResponseEntity<Object> handleBadRequest(Exception ex, HttpHeaders headers, HttpStatus status,
	    WebRequest request) {
