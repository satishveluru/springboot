...
public class AssertThatTest {
	 ...
	 * 
	 * double originalPI = 3.14; assertThat(originalPI, lessThanOrEqual(9.00));
	 * String authorName = "Sujoy"; assertThat(authorName,
	 * lessThanOrEqual("Sujoy1"));
	 * 
	 * int maxInt = Integer.MAX_VALUE; assertThat(maxInt,
	 * lessThanOrEqual(Integer.MIN_VALUE));
	 */
	}
}
