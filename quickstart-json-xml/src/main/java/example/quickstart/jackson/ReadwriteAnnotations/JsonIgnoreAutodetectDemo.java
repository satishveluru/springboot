package example.quickstart.jackson.ReadwriteAnnotations;
...
public class JsonIgnoreAutodetectDemo {
	...
	sc1 = mapper.readValue(new File("sc1.json"), SomeClass1.class);
	sc1.print();
	sc2 = mapper.readValue(new File("sc2.json"), SomeClass2.class);
	sc2.print();
	sc3 = mapper.readValue(new File("sc3.json"), SomeClass3.class);
	sc3.print();
    }
}
