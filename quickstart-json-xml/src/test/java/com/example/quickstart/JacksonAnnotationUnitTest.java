...
import example.quickstart.jackson.annotation.bidirection.ItemWithIdentity;
import example.quickstart.jackson.annotation.bidirection.ItemWithRef;
import example.quickstart.jackson.annotation.bidirection.UserWithIdentity;
import example.quickstart.jackson.annotation.bidirection.UserWithRef;
import example.quickstart.jackson.annotation.date.EventWithFormat;
import example.quickstart.jackson.annotation.date.EventWithSerializer;
import example.quickstart.jackson.annotation.dto.DistanceEnumWithValue;
import example.quickstart.jackson.annotation.dto.User;
import example.quickstart.jackson.annotation.dto.UserWithRoot;
import example.quickstart.jackson.annotation.dto.UserWithRootNamespace;
import example.quickstart.jackson.annotation.ignore.MyMixInForIgnoreType;
import example.quickstart.jackson.annotation.ignoreview.Item;
import example.quickstart.jackson.annotation.ignoreview.Views;
import example.quickstart.jackson.annotation.misc.AliasBean;
import example.quickstart.jackson.annotation.misc.BeanWithCreator;
import example.quickstart.jackson.annotation.misc.BeanWithCustomAnnotation;
import example.quickstart.jackson.annotation.misc.BeanWithFilter;
import example.quickstart.jackson.annotation.misc.BeanWithGetter;
import example.quickstart.jackson.annotation.misc.BeanWithIgnore;
import example.quickstart.jackson.annotation.misc.BeanWithInject;
import example.quickstart.jackson.annotation.misc.ExtendableBean;
import example.quickstart.jackson.annotation.misc.MyBean;
import example.quickstart.jackson.annotation.misc.PrivateBean;
import example.quickstart.jackson.annotation.misc.RawBean;
import example.quickstart.jackson.annotation.misc.UnwrappedUser;
import example.quickstart.jackson.annotation.misc.UserWithIgnoreType;
import example.quickstart.jackson.annotation.misc.Zoo;
...
public class JacksonAnnotationUnitTest {
    ...
    @Test
    public void whenSerializingUsingJsonSerialize_thenCorrect() throws JsonProcessingException, ParseException, Exception {
    ...
    @Test
    public void whenSerializingUsingJsonFormat_thenCorrect() throws JsonProcessingException, ParseException, Exception {
        final SimpleDateFormat df = new SimpleDateFormat("dd-MM-yyyy hh:mm:ss");
    ...
    public void whenSerializingUsingMixInAnnotation_thenCorrect() throws JsonProcessingException {
        final Item item = new Item(1, "book", null);
	...
	/*
	 * // act ObjectMapper mapper = new XmlMapper(); mapper =
	 * mapper.enable(SerializationFeature.WRAP_ROOT_VALUE).enable(
	 * SerializationFeature.INDENT_OUTPUT); String result =
	 * mapper.writeValueAsString(author);
	 * 
	 * // assert assertThat(result, containsString("<user xmlns=\"users\">"));
	 * 
	 */        /*
            <user xmlns="users">
